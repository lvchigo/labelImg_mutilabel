...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, filename=None):
        ...
        self.loadPredefinedMitiClasses()
        
        # Main widgets and related state.
        #add by chigo
        #self.labelDialog = LabelDialog(parent=self, listItem=self.labelHist)
        self.labelDialog = LabelDialog(parent=self, listItem=self.labelHist, mutilistItem=self.mutilabelHist)
    ...
    def loadFile(self, filename=None):
        ...
        if QFile.exists(filename):
            ...
            if self.usingPascalVocFormat is True :
                    ...
                    xmlPath = os.path.join(self.lastOpenDir, basename + '.xml')
                    if os.path.isfile(xmlPath):
                        print ('xmlPath:{}').format(xmlPath)
...
#                    self.loadPascalXMLByFilename(xmlPath)
    ...
    def openPrevImg(self, _value=False):
        ...
        #add by chigo
            ...
            print ('At the begin of dir:{}!!').format(self.dirname)
            return
    ...
    def openNextImg(self, _value=False):
        ...
        if len(self.mImgList) <= 0:
            #add by chigo
            print ('No image in dir:{}!!').format(self.dirname)
            return
        ...
        if self.filename is None:
            ...
            #add by chigo
                ...
                print ('At the end of dir:{}!!').format(self.dirname)
                return
    ...
    def openFile(self, _value=False):
        ...
        #print ('load fileters:{}').format(filters)
        filename = unicode(QFileDialog.getOpenFileName(self,
...
#                    action.setEnabled(False)
    ...
    #add by chigo
    def loadPredefinedMitiClasses(self):
        predefined_muticlasses_path = os.path.join('data', 'muticlass', 'predefined_muticlasses.txt')
        if os.path.exists(predefined_muticlasses_path) is True:
            with open(predefined_muticlasses_path) as f:
                for index,line in enumerate(f):
                    line = line.strip()

                    mutilabellist = []
                    one_muticlasses_path = os.path.join('data', 'muticlass', line+'.txt')
                    print 'one_muticlasses_path:{}'.format(one_muticlasses_path)
                    if os.path.exists(one_muticlasses_path) is True:
                        with open(one_muticlasses_path) as mutifile:
                            for mutiIndex,mutiline in enumerate(mutifile):
                                mutiline = mutiline.strip()
                                if mutilabellist is None:
                                    mutilabellist = [mutiline]
                                else:
                                    mutilabellist.append(mutiline)
                    ...
                    if self.mutilabelHist is None:
                        self.mutilabelHist = [mutilabellist]
                    else:
                        self.mutilabelHist.append(mutilabellist)
